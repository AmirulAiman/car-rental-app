...
class BookingStatusOwner extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Booking Request:'.$this->booking->car->name.'('.$this->booking->car->plate_number.')',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.owners.booking-status',
            with: [
